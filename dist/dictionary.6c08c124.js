...
})({"fLlWL":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "fad70e936c08c124";
"use strict";
...
},{}],"7H6tn":[function(require,module,exports) {
...
let audio; //create audio variable
//data function
function data(result, word) {
    if (result.title) infoText.innerHTML = `Can't find the meaning of <span>"${word}"</span>. Please, try to search for another word.`;
        ...
        //pass response data to html elements
        ...
        audio = new Audio("https:" + result[0].phonetics[0].audio); //create new audio element and pass src
        if (definitions.synonyms[0] == undefined) {
            synonyms.parentElement.style.display = "block";
            synonyms.innerHTML = "none"; //if no synonym
        } else {
            synonyms.parentElement.style.display = "block";
            synonyms.innerHTML = "";
            for(let i = 0; i < 5; i++){
...
function fetchApi(word) {
    ...
    //fetch api response and return it with parsing into js object
...
},{}]},["fLlWL","7H6tn"], "7H6tn", "parcelRequire60da")

//# sourceMappingURL=dictionary.6c08c124.js.map
